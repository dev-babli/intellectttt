                ...
                <div className="col-lg-8 mt-30">
                  <div className="page-title-box">
                    ...
                    <h2 className="title">
                      ...
                      opportunities <br /> at Intellectt today.
                    </h2>
                  </div>
                </div>
              ...
              <div className="cp-details-wrap">
                <div className="cp-manager_info">
                  ...
                  <ul className="xb-details-content list-unstyled">
                    ...
                    <li>
                      <span>FullJob Type :</span> -Time
                    </li>
                    <li>
                      <span>Location :</span> Warsaw, Poland
                    </li>
                    <li>
                      <span>Working days </span>: $80k to $100k (Based on your
                      experience).
                    </li>
                    <li>
                      {" "}
                ...
                <div className="col-lg-12">
                  <div className="cs-contact-wrap cs-contact-form cd-contact-form">
                    ...
                    <p className="xb-content">
                      Intellectt doesn’t accept unsolicited resumes from
