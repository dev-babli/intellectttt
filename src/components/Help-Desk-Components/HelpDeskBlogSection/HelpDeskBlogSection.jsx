...
const HelpDeskBlogSection = (props) => {
    ...
    return (
        <section className="blog  pb-130" style={{ backgroundColor: props.bg }}>
                        ...
                        {blogs.slice(12, 13).map((blog, Bitem) => (
                            <div className="hd-blog hd-blog-left" key={Bitem}>
                                ...
                                <div className="xb-item--holder">
                                    ...
                                    <span className="xb-item--content">Intellectt’s AI-Support boosts efficiency and enhances customer service.</span>
                                </div>
                            </div>
                        ))}
                    </div>
