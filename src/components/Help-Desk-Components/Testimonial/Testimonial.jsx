...
import tImg1 from "../../../images/testimonial/Placeholder-2.webp";
import tImg2 from "../../../images/testimonial/Placeholder-2.webp";
import tImg3 from "../../../images/testimonial/Placeholder-2.webp";
...
const Testimonial = () => {
    const testimonials = [
        {
            authorImg: tImg1,
            content:
                "“We love Intellecttbecause their API allows us to explore ways to get customer data more personalized experience.”",
            name: "Laurie Leduc",
    ...
    return (
        <section className="testimonial pb-155" style={{ backgroundColor: "#fff" }}>
                            ...
                            <div className="testimonial-item hd-testimonial-item pos-rel">
                                <div className={`xb-item--inner tes-bg--${index + 1} ul_li`}>
                                    <div className="xb-item--author">
                                        <img src={testimonial.authorImg} alt={testimonial.name} style={{height: "300px"}}/>
                                    </div>
