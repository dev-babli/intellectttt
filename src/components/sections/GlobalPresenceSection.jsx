...
import { BRAND_COLORS, GLOBAL_DATA } from "../../constants";
          ...
          >
            <Box sx={{ textAlign: "center", position: "relative", zIndex: 2 }}>
              ...
              <Grid container spacing={4} justifyContent="center" sx={{ mt: 6 }}>
                {[
                  { number: GLOBAL_DATA.totalCountries.toString(), label: "Countries", icon: Public },
                  { number: GLOBAL_DATA.totalOffices + "+", label: "Offices", icon: Business },
                  { number: GLOBAL_DATA.totalEmployees + "+", label: "Professionals", icon: People },
                  { number: GLOBAL_DATA.totalProjects + "+", label: "Projects", icon: TrendingUp },
                ].map((stat, index) => (
      ...
      <Box sx={{ py: { xs: 6, md: 10 }, background: BRAND_COLORS.lightGray }}>
        <Container maxWidth="lg">
          ...
          >
            ...
            >
              {/* Interactive Markers */}
              {GLOBAL_DATA.countries.map((country, index) => (
                <motion.div
                  key={country.name}
