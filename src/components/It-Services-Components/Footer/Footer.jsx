        ...
        <div className="row pb-95">
          <div className="col-lg-4">
            <div className="xb-newslatter">
              ...
              <span className="xb-item--content">Want to stay up to date? Sign up for Intellectt it services update.</span>
          ...
          <div className="col-lg-8">
            <div className="xb-footer is-footer ml-75">
              ...
              <div className="footer-copyright mt-50 ul_li_between">
                <p className="copyright mt-20">Copyright © 2024 <Link onClick={ClickHandler} to="/home">Intellectt</Link>. All rights reserved.</p>
